				...
				<form action="update" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="col-md-6 offset-md-3">
							...
							<input type="file" name="foto" class="form-control-file input-group-text" id="foto">
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-6 offset-md-3">
					...
					<div class="form-group">
						<div class="   col-md-6 offset-md-3">
							...
							value="<?php echo !empty($aluno['cpf']) ? $aluno['cpf'] : ''?>">
						</div>
					</div>
					<div class="form-group">
						<div class="   col-md-6 offset-md-3">
					...
					<div class="form-group">
						<div class="col-md-6 offset-md-3">
							...
							value="<?php echo !empty($aluno['cep']) ? $aluno['cep'] : ''?>" >
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-6 offset-md-3">
